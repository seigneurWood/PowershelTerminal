...
[Files]
; Исполняемый файл
Source: "..\..\..\PSterminal\bin\Release\PSterminal.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "dotNetFx45_Full_setup.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall; Check: not IsRequiredDotNetDetected

; Прилагающиеся ресурсы
Source: "..\..\..\PSterminal\bin\Release\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
